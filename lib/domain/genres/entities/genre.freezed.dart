...
abstract class $GenreCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String? imageUrl, bool isSelected});
}
...
class _$GenreImpl implements _Genre {
  const _$GenreImpl(
      {required this.name, required this.imageUrl, required this.isSelected});
  ...
  @override
  String toString() {
    return 'Genre(name: $name, imageUrl: $imageUrl, isSelected: $isSelected)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, imageUrl, isSelected);
...
abstract class _Genre implements Genre {
  const factory _Genre(
      ...
      required final bool isSelected}) = _$GenreImpl;
