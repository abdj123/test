...
class _$AvailabilityImpl implements _Availability {
  const _$AvailabilityImpl({required this.sold, required this.available});
  ...
  @override
  String toString() {
    return 'Availability(sold: $sold, available: $available)';
  }
...
abstract class _Availability implements Availability {
  const factory _Availability(
      ...
      required final int available}) = _$AvailabilityImpl;
